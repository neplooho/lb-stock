...
Хештеги выбираются кнопочками, если у хештега стоит галочка то он будет добавлен в объявление. Минимальное количество 1 хештег
Картинки нужно грузить как файлы без сжатия чтобы они были хорошего качества в итоге. Максимальный размер одной картинки 5мб"""
...
def set_description(conn, chat_id, description, *args):
    ...
    cur.execute("UPDATE stock_sessions SET step = '/images', description = '" + description.replace('\'',
                                                                                                    '\'\'') + "' WHERE chat_id = " + str(
        chat_id))
    send_message(chat_id, "Отличное описание. Теперь картинки.\nУчти что я могу обработать как картинки файлами так и сжатыми. НО \n"
